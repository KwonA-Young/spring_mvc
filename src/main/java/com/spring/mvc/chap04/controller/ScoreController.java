...
/* 학생의 성적정보를 조회, 등록, 삭제할 수 있는 시스템 만들기
    요청 URL 종류
...
public class ScoreController {
    ...
    public String register (Score score) {
        System.out.println("/score/regitser : POST방식");
    ...
    public String detail (Model model, int studentNumber) {
        System.out.println("/score/detial : GET방식");
        System.out.println("전달받은 studentNumber : " + studentNumber);
        // 레포지토리에서 Score 객체를 받아서 저장하고 .jsp파일로 보낼 수 있게 적재해주세요.
